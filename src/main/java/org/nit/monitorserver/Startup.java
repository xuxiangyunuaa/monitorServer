...
//    private static final SQLClient mySQLClient = new MysqlConnection().getMySQLClient();
    ...
    public static void main(final String[] args) {
        ...
        logger.info(("@@@@@@@@@@@@@@@" + DateUtil.dateToStr(new Date()) + " 宿主机端应用监控与分析评估工具服务器启动"));
        try {
            //获取 vertx 实例
...
//                System.out.println("请输入一条指令！");
            ...
            while (scanner.hasNextLine()){
                ...
                logger.error(es);
                logger.info(("@@@@@@@@@@@@@@@" + DateUtil.dateToStr(new Date()) + " 宿主机端应用监控与分析评估工具服务器退出:" + es));
        }
    }
